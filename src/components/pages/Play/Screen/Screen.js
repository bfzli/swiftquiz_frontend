...
export default function Screen({ quiz }) {
  ...
  const prg = (countDown / (60 * 0.25)) * 100;
    ...
    <>
      {quiz !== null ? (
        <main className={styles.container}>
          <Helmet>
            <title>{questions.title} - Swiftquiz</title>
            <meta
              name="description"
              ...
              <>
                <div className={styles.view_container}>
                  <div className={styles.view_wrapper}>
                    ...
                    >
                      ...
                      <p className={styles.view_item_text}>
                        Anwsers
                ...
                <div className={styles.general_stats}>
                  <div className={styles.stats_boxes}>
                    <h3 className={styles.stats_icon}>
                      {minutes}:{seconds}
                    </h3>
                    <p className={styles.stats_description}>
                      {t("play_enter.timeleft")}
                    </p>
              ...
              <>
                ...
                <div className={styles.general_corrector}>
                  {currentQuestion === 0 ? (
                    <>
                      <lottie-player
                        src="https://assets8.lottiefiles.com/packages/lf20_dmw3t0vg.json"
                      ...
                      <h3 className={styles.nothing}>
                        Nothing yet, start playing the quiz.
                      </h3>
                    </>
                  ) : null}
                          ...
                          <p className={styles.question_box}>
                            {item.isCorrect === "answer1" ? (
                              ...
                              >
                                <path
                                  opacity="0.4"
                                  d="M11.9999 1.99979C17.5149 1.99979 21.9999 6.48579 21.9999 11.9998C21.9999 17.5138 17.5149 21.9998 11.9999 21.9998C6.48588 21.9998 1.99988 17.5138 1.99988 11.9998C1.99988 6.48579 6.48588 1.99979 11.9999 1.99979"
                                  fill="#33E790"
                                />
                                <path
                                  d="M11.113 15.2255C10.8983 15.2255 10.6837 15.1441 10.5198 14.9802L8.2458 12.7062C7.91807 12.3784 7.91807 11.8475 8.2458 11.5208C8.57353 11.193 9.10347 11.1921 9.4312 11.5198L11.113 13.2016L15.0688 9.2458C15.3965 8.91807 15.9265 8.91807 16.2542 9.2458C16.5819 9.57353 16.5819 10.1044 16.2542 10.4322L11.7062 14.9802C11.5423 15.1441 11.3276 15.2255 11.113 15.2255"
                                  fill="white"
                                />
                              </svg>
                            ) : (
              ...
              <>
                ...
                <div className={styles.anwsers} data-aos="fade-right">
                  <div
                    ...
                    onClick={(which) => {
                      handleAnswer(
                        questions.questions[currentQuestion].isCorrect ===
                          "answer1"
                          ? "answer1"
                          : null
                      );
                    }}
                    className={styles.anwser}
                  >
                    {questions.questions[currentQuestion].answer1}
                  </div>
                  <div
                    data-aos="fade-right"
                    onClick={(which) => {
                    ...
                    className={styles.anwser}
                  >
                    {questions.questions[currentQuestion].answer2}
                  </div>
                  <div
                    data-aos="fade-right"
                    onClick={(which) => {
                    ...
                    className={styles.anwser}
                  >
                    {questions.questions[currentQuestion].answer3}
                  </div>
                  <div
                    data-aos="fade-right"
                    onClick={(which) => {
                    ...
                    className={styles.anwser}
                  >
                    {questions.questions[currentQuestion].answer4}
                  </div>
                </div>
              </>
            ) : (
