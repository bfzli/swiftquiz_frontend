                    ...
                    <>
                        {questionList.map((item, i) => {
                            return (
                                ...
                                <div onClick={() => deleteQuestion(i)} key={i} className={i === item.id ? styles.single_slide_active : styles.single_slide}>
                                    {item.question}
                        ...
                        <div className={styles.savingit}>
                            {
                                saving === true ?
                                    ...
                                    <>
                                        ...
                                        <div onClick={() => navigator.clipboard.writeText(givenCode)} className={styles.copy_code}>
                                            <p>{givenCode}</p>
