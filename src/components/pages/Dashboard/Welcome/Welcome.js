			...
			<main className={styles.main}>
				<div className={styles.main_top}>
					<div data-aos="fade-right" className={styles.top_left}>
						<h2 className={styles.top_right_title}>YOUR QUIZES</h2>
										...
										<div className={styles.your_quiz}>
											<div className={styles.your_quiz_wrapper}>
												<img
													...
													alt="Blog"
													className={styles.your_quiz_thumb}
												/>
												<div className={styles.your_quiz_info}>
													<p className={styles.quiz_title}>{current.title}</p>
													<p className={styles.quiz_description}>{current.description}</p>
													<p className={styles.quiz_description}>{current.redeem_code}</p>
												</div>
											</div>
											<div>
					...
					<div className={styles.top_right} data-aos="fade-left">
						...
						<div className={styles.quizess}>
							...
							<div className={styles.quiz}>
								...
								<h3 className={styles.quiz_title}>TYPESCRIPT</h3>
								<p className={styles.quiz_description}>
							...
							<div className={styles.quiz}>
								...
								<h3 className={styles.quiz_title}>KOTLIN</h3>
								<p className={styles.quiz_description}>
							...
							<div className={styles.quiz}>
								...
								<h3 className={styles.quiz_title}>REACT</h3>
								<p className={styles.quiz_description}>
							...
							<div className={styles.quiz}>
								...
								<h3 className={styles.quiz_title}>DOCKER</h3>
								<p className={styles.quiz_description}>
