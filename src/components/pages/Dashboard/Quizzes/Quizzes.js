		...
		<div className={styles.container}>
			<div className={styles.page_info} data-aos="fade-down">
				...
				<div className={styles.search}>
					<input className={styles.search_input} type="text" placeholder={t("quizzes.search")} onChange={handleOnChange} />
					...
					<Link to="/dashboard/quizzes/add-quiz" className={styles.add_btn}>
						...
						<p className={styles.add_btn_txt}>{t("quizzes.addquiz")}</p>
					</Link>
				</div>
			</div>
				...
				<div className={styles.top_right} data-aos="fade-left">
					...
					{userQuizes === null || userQuizes.length === 0
						...
						<div className={styles.emptystate}>
							...
							<h2 className={styles.emptystatetitle}>{t("quizzes.emptyone")}</h2>
							<h2 className={styles.emptystatetitle}>{t("quizzes.emptytwo")}</h2>
						</div>
					}
