  ...
  const pay = async () => {
    ...
    try {
      const response = await fetch(
        "https://swiftapi.vercel.app/api/user/pay/coins",
        {
          method: "POST",
          headers: {
    ...
    <div className={styles.modal_container}>
      <div className={styles.modal_box}>
        <div className={styles.modal_header}>
          ...
          <svg
            onClick={() => (state === "loading" ? null : setCheckout(false))}
