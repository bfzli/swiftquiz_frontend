    ...
    return (
        <section className={styles.container}>
            <div className={styles.box}>
                ...
                <p className={styles.form_description}>By joining us youll earn many benefits.</p>
                ...
                <p onClick={() => setIsLogin('reset')} className={styles.forgotpasswordtxt}>Forgot password? Reset it now!</p>

                <button className={styles.button}>Login</button>

                <p onClick={() => setIsLogin('register')} className={styles.noaccount}>
                    Don't have on, signup instead.
                </p>
            </div>
        </section>
    )
