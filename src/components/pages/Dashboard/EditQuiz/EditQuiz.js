...
export default function Quiz() {
    ...
    function checkValidation() {
      ...
      if (isEmpty(errors) === true || isEmpty(errors) === null) {
        dispatch(editQuiz(params.id, quiz, quizImage));
        message.title = 'The Quiz was edit!';
        message.description = 'The quiz was succesfully edited, you can now play it or share with friends, we are redirecting you to your quizzes.';
                ...
                {mode === 'edit' ? (
                  <>
                    <div
                      ...
                      <div className={styles.navicon_text}>Edit Question</div>
                    </div>
                  </>
                ) : null}
