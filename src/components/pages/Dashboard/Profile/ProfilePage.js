         ...
         <div className="bottomProfileCont">
            <div className="leftBottomProfileCont">
               ...
               <p>
                  ...
                  suscipit itaque! Saepe fugit iste delectus, magnam mollitia
                  sit commodi corrupti!
               </p>
               <Link to="/updateProfil">
                  <button className={styles.button_fill_purple}>
                     Edit Profile
                  </button>
               </Link>
            </div>
               ...
               <div className="profileQuizes">
                  <div className="QuizBody">
                     ...
                     <p>
                        ...
                        In other words, we can say that every application you
                        will develop in made of components.
                     </p>
                  ...
                  <div className="QuizBody">
                     ...
                     <p>
                        A query language for your API — GraphQL provides a
                        complete description of the data in your API, gives
                  ...
                  <div className="QuizBody">
                     ...
                     <p>
                        Svelte is a JavaScript framework for building user
                        interfaces. Its compiler architecture enables amazing
                        tradeoffs for UX and DX.
                     </p>
                     <div className="quizBottom">
                        <img src={adnanAvatar} />
                        <div className="quizBottomRight">
