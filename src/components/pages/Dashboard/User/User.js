...
import { getUserById } from '../../../../reduxComponents/actions/User';
                                ...
                                <div className={styles.quizzes}>
                                    <div className={styles.quiz}>
                                        ...
                                        </svg>
                                        {
                                            dropdown === true ?
                                                <div className={styles.dots_dropdown}>
                                                    <Link to={`/invite/}`} className={styles.quiz_play}>
                                                        ...
                                                        <p className={styles.actions_txt}>Share</p>
                                                    </Link>
                                                    ...
                                                    <div className={styles.quiz_play}>
                                                        ...
                                                        <Link to={`/dashboard/quizzes/edit-quiz/q`} className={styles.actions_txt}>Edit</Link>
                                                    </div>
                                                    ...
                                                    <div onClick={() => dispatch(removeQuiz("item._id"))} className={styles.quiz_play}>
                                                        ...
                                                        <p className={styles.actions_txt}>Delete</p>
                                                    </div>
                                                </div>
                                                : null
                                        }
                                        ...
                                        <p className={styles.quiz_description}>
                                            Lorem ipsum dolor sit amne? Porro. Lorem ipsum dolor sit amet.
                                        </p>
                                    </div>
                                </div>
                            </div>
