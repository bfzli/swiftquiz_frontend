            ...
            <section className={styles.section2}>
                ...
                <div className={styles.hero}>
                    ...
                    <div className={styles.s2content}>
                        ...
                        <div>
                            {{
                                "one": <><img src={theme === "darkmode" ? playing_quiz_dark : playing_quiz_light} width="100%" /> <p className={styles.currentContent}>Play quizzes of your wish, get one from your friends.</p></>,
                                ...
                                "three": <><img src={theme === "darkmode" ? playing_quiz_dark : playing_quiz_light} width="100%" /> <p className={styles.currentContent}>Share quizzes to the community so they can play your quizzes.</p></>,
                            }[s3view]}
                        </div>
                    </div>
                </div>
            ...
            <section className={styles.section4}>
                ...
                <div className={styles.hero}>
                    ...
                    <p style={{ marginBottom: "10%" }} className={styles.s3description}>
                        See what others say about us, so you can have an idea of how good this platform is, are you ready to learn with us? Give it a try!
                    </p>
                    ...
                    <div className={styles.slider}>
                        {
                            {
                                "one": <div className={styles.slidercontainer}>
                                    ...
                                    <div className={styles.reviewwho}>
                                        <img className={styles.reviewer_avatar} src="https://i.pinimg.com/originals/f0/b6/ea/f0b6ea6cdb83304ab03251a620116c44.jpg" />
                                        <p className={styles.reviewer_name}>Rinor Sylejmani</p>
                                    </div>
                                </div>,
                                "two": <div className={styles.slidercontainer}>
                                    <div className={styles.reviewbody}>
                                        <p className={styles.reviewp}>
                                            “Me and my team had fun playing some quizzes, we recommend it to every student and learner who want to be something.”
                                        </p>
                                    </div>
                                    <div className={styles.reviewwho}>
                                        <img className={styles.reviewer_avatar} src="https://i.pinimg.com/originals/f0/b6/ea/f0b6ea6cdb83304ab03251a620116c44.jpg" />
                                ...
                                "three": <div className={styles.slidercontainer}>
                                    <div className={styles.reviewbody}>
                                        <p className={styles.reviewp}>
                                            “Our presentations have to live up to our high standards for product design. Pitch allows us to create internal and external assets that look amazing, without spending hours on it.”
                                        </p>
                        ...
                        <div onClick={() => handleRight()} className={styles.goright}>
                            <svg className={styles.arrows} viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
