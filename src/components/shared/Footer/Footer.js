import { container, testing, left, right, center, cta_name, links, cta_wrapper, cta_svg, logo, contact_title, link, smm, smm_icon, links_flex, top, bottom, description, copyright, newsletter_input, newsletter_title } from './Footer.module.scss'
        ...
        <footer className={container} data-aos="fade-up">
            <div className={top}>
                <div className={left}>
                    ...
                    <div className={smm}>
                        <Link to="facebook.com/swiftquiz" style={{ marginRight: '1.5em' }}>
                            <svg id="cursor_hover" className={smm_icon} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className={bottom}>
                <p className={copyright}>All rights Reserved | SwfitQuiz 2021  </p>
            </div>
        </footer>
    )
}