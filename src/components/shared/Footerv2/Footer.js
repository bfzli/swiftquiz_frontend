    ...
    return (
        <footer className={styles.footer}>
            <div className={styles.foostart}>
                <div className={styles.fooone}>
                    ...
                    <p className={styles.description}>
                        Lorem ipsum dolor sit aumquam exercitationem non eliquid?
                    </p>

                </div>

                {/* <div className={styles.footwo}>
                    ff
                </div> */}

                <div className={styles.foothree}>
                    <h2 className={styles.linkthree} style={{fontFamily: 'Markpromedium'}}>Links</h2>
            ...
            <div className={styles.fooend}>
                <div>
                    <p className={styles.logo_name}>Swiftquiz &copy; All rights reserved. Made with by <a href="">Swift Team</a></p>

                </div>
                <div style={{display: 'flex'}} onClick={() => handleTheme()}>
                   <select className={styles.footbox} style={{marginRight: '1em'}}>
                       <option>English</option>
                       <option>Shqip</option>
                   </select>

                   <select className={styles.footbox} >
                       <option className={styles.footboxchild}>Darkmode</option>
                       <option className={styles.footboxchild}>English</option>
                   </select>
                </div>
            </div>
        </footer>
