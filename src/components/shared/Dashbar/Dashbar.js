...
export default function Dashbar() {
    ...
    return (
        <>
        <p className={styles.testing} onClick={() => setMenuIsOpen(!menuIsOpen)}>
            {
                menuIsOpen === false ?

                'big menu is closed' : 'big menu is open'
            }
        </p>
            {
                menuIsOpen === false ?
                    <header className={styles.container}>
                        ...
                        <div className={styles.center}>
                            <div className={styles.icon_holder_active} title="Home">
                                <svg className={styles.icon_active} viewBox="0 0 62 62" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <header className={styles.container_mobile}>
                        <div className={styles.top}>
                            <Logo />
                        </div>
                        ...
                        <div className={styles.center}>
                            <div className={styles.icon_holder_active} title="Home">
                                ...
                                <p className={styles.icon_menu_text}>Home</p>
                            </div>
